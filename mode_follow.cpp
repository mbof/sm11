...
void FollowMode::control() {
  // HIGH means there is something close to the sensor.
  bool proximity_left = (digitalRead(PIN_PROXIMITY_LEFT) == HIGH);
  bool proximity_right = (digitalRead(PIN_PROXIMITY_RIGHT) == HIGH);
